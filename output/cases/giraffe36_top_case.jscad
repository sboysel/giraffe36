function giraffe36_top_plate_extrude_2_outline_fn(){
    return new CSG.Path2D([[237.925,-98.5533791],[200.2023858,-94.3285663]]).appendArc([199.6458808,-94.2975],{"radius":5,"clockwise":false,"large":false}).appendPoint([181.4774463,-94.2975]).appendArc([180.2897952,-94.4405992],{"radius":5,"clockwise":false,"large":false}).appendPoint([145.7348489,-102.8902717]).appendArc([141.9225,-107.7471724],{"radius":5,"clockwise":false,"large":false}).appendPoint([141.9225,-159.4046567]).appendArc([145.176799,-164.0900092],{"radius":5,"clockwise":false,"large":false}).appendPoint([210.0485274,-188.2603676]).appendArc([210.96311,-188.7121765],{"radius":5,"clockwise":true,"large":false}).appendPoint([248.8703244,-212.5323986]).appendArc([255.3608302,-211.5127931],{"radius":5,"clockwise":false,"large":false}).appendPoint([266.5567604,-198.1700029]).appendPoint([237.925,-169.06875]).appendPoint([237.925,-98.5533791]).close().innerToCAG()
.subtract(
